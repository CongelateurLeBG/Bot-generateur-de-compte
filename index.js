...
bot.on('ready', msg => {
    ...
    console.log((chalk.cyan(`                                                                        #             #       #      ##   # `)));
    console.log((chalk.cyan(`                                                                        #             #  #### #####  # #  # `)));
    console.log((chalk.cyan(`                                                                        #   _____     #     # #      #  # # `)));
    console.log((chalk.cyan(`                                                                        #   _____     #     # #      #   ## `)));
    console.log((chalk.cyan(`                                                                        #              #####  ###### #    # `)));
    console.log("");
    console.log((chalk.yellow(`                                                               Crée par Congélateur !`)));
    console.log((chalk.yellow(`                                                                © 2021 T-gen, Inc.`)));
    console.log("");
    ...
    bot.user.setActivity("+help - T-Gen (site en dev)");
});
    ...
    if (message.channel.id === config.botChannel) {
        ...
        if (command === "gen") {
            if (generated.has(message.author.id)) {
                ...
                const embed = {
                    ...
                    timestamp: new Date(),
                    footer: {
                        icon_url: "https://media.discordapp.net/attachments/813451346464342047/813453149393911818/T-gen.gif?width=980&height=551",
                        text: "Développé par Congélateur"
                    },
                    image: { url: "https://media.discordapp.net/attachments/813451346464342047/813453149393911818/T-gen.gif?width=980&height=551" },
                    author: {
                        name: botname + " - générateur de compte",
                        url: "https://discord.gg/elitefr",
        ...
        if (command === "help") {
            ...
            const embed = {
                ...
                timestamp: new Date(),
                footer: {
                    text: 'Développé par Congelateur',
                    icon_url: 'https://media.discordapp.net/attachments/813451346464342047/813453149393911818/T-gen.gif?width=980&height=551',
                },
            };
            message.channel.send({ embed });
